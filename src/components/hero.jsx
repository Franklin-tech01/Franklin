				...
				<div className='flex flex-col items-start flex-1 md:flex md:flex-row md:gap-10 md:items-center lg:flex lg:flex-row lg:items-center lg:gap-x-12 lg:justify-between'>
					<div>
						...
						<p className='gradientText font-medium font-pop text-[15px] text-[#FFFFFF99] max-w-[353px] mt-[45px] md:mt-8 lg:mt-1 md:max-w-[639px] md:text-[18px] leading-md:[27px]'>
							I build products that are not only functional but also visually
							appealing, ensuring a seamless user experience across all devices.
						</p>
						<div
							id='intro'
							...
							<p className='max-w-[310px]'>
								4+ Years of experience. Passionate about crafting intuitive and
								engaging user interfaces that enhance the overall user
								experience.
							</p>
							<p className='max-w-[319px]'>
								I specialize in creating responsive and accessible web
						...
						<div className='mt-[35px] md:mt-[65px] flex justify-start items-center  gap-[26px] md:gap-[40px]'>
							<motion.a
								href='https://web.facebook.com/profile.php?id=100073224439631'
								target='_blank'
								rel='noreferrer'
								whileTap={{ scale: 1.1 }}
							...
							<motion.a
								href='https://www.instagram.com/da_tekii/'
								target='_blank'
								rel='noreferrer'
								whileTap={{ scale: 1.1 }}
								whileHover={{ scale: 0.99 }}
							...
							<motion.a
								href='https://www.linkedin.com/in/franklin-mike/'
								target='_blank'
								rel='noreferrer'
								whileTap={{ scale: 1.1 }}
								whileHover={{ scale: 0.99 }}
